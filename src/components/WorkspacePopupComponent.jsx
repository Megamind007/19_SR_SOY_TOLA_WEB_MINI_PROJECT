...
export default function WorkspacePopupComponent() {
  // async function handleAddNewWorkSpace(newSpace) {
  //   const newWork = {
  //     workspaceName: newSpace.get("workspaceName"),
  //   };
  //   await addWorkSpaceService(newWork);

  //   console.log("Add New Data : ", newWork);
  // }
  return (
    <div>
